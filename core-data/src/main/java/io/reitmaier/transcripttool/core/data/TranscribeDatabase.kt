...
interface TranscribeDatabase {
  companion object Factory {
    fun build(sqlDriver: SqlDriver): TranscribeDatabase {
      return TranscribeDatabaseImpl(TranscriptToolDb(
        driver = sqlDriver,
...
//    }
  ...
  fun insertLocalTask(remoteId: RemoteId, remoteUrl: String, fileId: FileId, path: String, displayName: String, durationMs: Long): DbResult<Task_Entity>
  ...
  fun insertPartialTranscript(
    ...
    transcript: String): Partial_Transcript_Entity
